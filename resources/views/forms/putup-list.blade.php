...
<head>
    ...
    <style>
        .horizontalTable {
            ...
            /* Ensures border lines are not doubled */
            width: 100%;
            /* Optional: Adjust the table width */
        }
        ...
        .horizontalTable th {
            ...
            /* Optional: Adds a light gray background to header cells */
        }
    </style>
</head>
...
<body>
    ...
    <div class=" xl:ml-[280px]" id="body2">
        ...
        <div class="container" id="printable-section">
            <div class="bg-white " contentEditable="true" id="dynamic-table">
                ...
                <div id="tableContainer" class=' h-[800px] pt-10'>
                    <span
                        class="font-bangla text-center border-b-2 mt-5 pb-3 flex justify-center pb-1 px-3 text-sm font-semibold"
                        id="intro-line">
                    ...
                    ">
                        ...
                        <div class="text-[12px] w-full !flex justify-around my-5">
                            ...
                            <div
                                class="flex gap-y-16 flex-col items-center font-bangla text-[12px] text-center gap-y-20">
        ...
        function createNewTable(index) {
            ...
            baseRows.forEach((row) => {
                ...
                for (let i = 1; i < row.cells.length; i++) {
                    ...
                    emptyCell.className = row.cells[i]?.className ||
                    "data-cell-class"; // Keep the same class as the original
    ...
    if (!printableSection) {
        console.error('No printable section found!');
        return;
    }

    // Get all elements inside <body> except #printable-section
    const bodyElements = Array.from(document.body.children);
    const elementsToHide = bodyElements.filter(el => el.id !== 'body2'); // Hide everything except #body2

    // Hide sidebar and navbar (since they're inside #body2)
    const body2Children = Array.from(document.getElementById('body2').children);
    const elementsInsideBody2 = body2Children.filter(el => el.id !== 'printable-section'); // Hide everything except #printable-section

    // Store original display styles
    const originalStyles = [...elementsToHide, ...elementsInsideBody2].map(el => el.style.display);

    // Hide all elements except #printable-section
    [...elementsToHide, ...elementsInsideBody2].forEach(el => (el.style.display = 'none'));
    ...
    // Ensure margin-top for '.intro-line' elements
    ...
    // Restore original display styles after printing
    [...elementsToHide, ...elementsInsideBody2].forEach((el, i) => {
