        ...
        <div class="w-[90%] mx-auto">
            <div class=" pt-[160px] text-[10px] font-medium text-black leading-5 font-bangla" contenteditable="true"
                ...
                <p class=" text-[10px] text-black font-medium">
                    ...
                    জন কর্মীর ওকালাকৃত হওয়ার এবং কর্মীগনের ভিসা ও চুক্তিপত্র সঠিক থাকায় প্রয়োজনীয় অন্যান্য ডকুমেন্টসহ
                    বহির্গমন ছাড়পত্রের জন্য দাখিল করলাম। উল্লেখ্য যে, ভিসাগুলো একক ভিসা এবং তা ২৫ এর অধিক নয় ও কর্মীদের
                ...
                <div class="flex mb-5" style="display:flex">
                    <div class="w-2/3 ">
                        <ul class='text-[10px]'>
                            ...
                            <li>খ) কল্যান ও বীমা ফি এবং স্মার্টকার্ড ফি বাবদ প্রাপ্ত পে-অর্ডারের ফটোকপি- পতাকা 'গ'।</li>
                            <li>গ)রিক্রুটিং এজেন্সী কর্তৃক ৩০০/- টাকার নন-জুডিসিয়াল স্ট্যাম্পে অঙ্গিকারনামা-পতাকা 'ঘ'।
                            </li>
                    ...
                    <table class="w-full text-[8px] border-collapse border border-black" id="application_table">
                        <thead>
                            <tr class="">
                                ...
                                <th colspan="2" class="border border-black px-4  text-center">ভিসা ও আইডি নম্বর</th>
                            </tr>
                        </thead>
                        <tbody>
