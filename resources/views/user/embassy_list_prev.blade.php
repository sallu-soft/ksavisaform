    ...
    <div class="container  ">
        ...
        <div class="d-flex max-w-[1050px] mx-auto mt-2 bg-gray-200 rounded-lg px-2 py-1 items-center"
            ...
            <div class="flex items-center gap-3">
                <div>
                    ...
                    <input list="candidates" name="re_stamping" id="re_stamping" class="form-control"
                    style="display: none;" onchange="restamping()" />
                </div>
                <div class="text-xl font-bold">
                    ...
                    <input type="radio" id="Re-Stamping" name="emb_list" value="Re-Stamping" onchange="toggleInputBox()" />
                    <label for="Re-Stamping">Re-Stamping</label>
                </div>
            </div>
            ...
            <table class="w-full table-bordered" id="embassy_list">
                ...
                <thead>
                    <tr
                        ...
                        <th colspan="7" class="border border-black"> جديد / Re-Stamping</th>

                    </tr>
                </thead>

                <tbody id="table_re-stamping_body">
        ...
        <script type="text/javascript">
            ...
            function toggleInputBox() {
                ...
                } else if (radioSelection === 'Re-Stamping') {
                    inputNew.style.display = 'none';
                    inputCancel.style.display = 'none';
                    inputReStamping.style.display = 'block';
            ...
            var rowsData = [];
            var cancelRowsData = [];
            var reStampingRowsData = [];



            function restamping(id = null) {
                if (id == null) {
                    var id = document.getElementById('re_stamping').value;
                }
                let input = document.getElementById('re_stamping');
                ...
                if (selectedOption) {
                    ...
                    fetch('/user/embassy/' + candidateId, {
                        ...
                        .then(data => {
                            var existingRow = findRowById(data[0].passport_number, 'table_re-stamping_body');
                            ...
                            document.getElementById('re_stamping').value = null;
                            updateTotalCount();
                        })
                        .catch(error => {
                            console.error(error);
            ...
            function overwriteRowData(row, data) {
                ...
                row.children[1].textContent = data.visa_no.substr(0, 4);
