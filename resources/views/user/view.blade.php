                ...
                {{-- <h1 class="text-danger fw-bold text-center my-5">Edi</h1> --}}
                    ...
                    <div class="w-[60%] mx-auto">
                        ...
                        <div class="bg-white container shadow-2xl py-3 my-3 rounded-lg">
                            <div
                                class="flex text-[#082F2C] bg-[#ADCCC8] rounded-lg p-3 text-xl  font-semibold justify-between items-center">
                                <h2 class="">Candidate Information</h2>
                            </div>
                                ...
                                <div class="px-10 gap-x-10 grid md:grid-cols-2">
                                    <div class="py-1">
                                        ...
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full uppercase form-control" name="pname"
                                            id="pname" value="{{ $candidate->name }}" />
                                    </div>
                                    <div class="py-1">
                                        <div class="font-bold text-lg">Passport Number</div>
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full uppercase form-control" minlength="0"
                                            maxlength="9" id="pnumber" name="pnumber"
                                            value="{{ $candidate->passport_number }}" required />
                                    </div>
                                    <div class="py-1">
                                        <div class="font-bold text-lg">Passport Issue Date</div>
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full uppercase form-control" name="pass_issue_date"
                                            id="pass_issue_date" value="<?php
                                    ...
                                    <div class="py-1">
                                        ...
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full uppercase form-control" name="pass_expire_date"
                                            id="pass_expire_date" value="<?php
                                    ...
                                    <div class="py-1">
                                        ...
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full uppercase form-control" name="date_of_birth"
                                            id="date_of_birth" value="<?php
                                    ...
                                    <div class="py-1">
                                        ...
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full uppercase form-control" name="place_of_birth"
                                            id="place_of_birth" value="{{ $candidate->place_of_birth }}" />

                                    </div>
                                    <div class="py-1">
                                        <div class="font-bold text-lg">Father's Name</div>
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full uppercase form-control" name="father"
                                            id="father" value="{{ $candidate->father }}" />
                                    </div>
                                    <div class="py-1">
                                        <div class="font-bold text-lg">Mother's Name</div>
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full uppercase form-control" name="mother"
                                            id="mother" value="{{ $candidate->mother }}" />
                                    </div>
                                    <div class="py-1">
                                        <div class="font-bold text-lg">Religion</div>
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full uppercase form-control" name="religion"
                                            id="religion" value="{{ $candidate->religion }}" />
                                    </div>

                                    <div class="py-1">
                                        <div class="font-bold text-lg">Gender</div>
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full uppercase form-control" name="gender"
                                            id="gender" value="{{ $candidate->gender }}" />
                                    </div>
                                    ...
                                    <div class="py-1">
                                        ...
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full uppercase form-control" name="mother"
                                            id="mother" value="{{ $candidate->married }}" />
                                    </div>
                                    <div class="py-1">
                                    ...
                                    <div class="py-1">
                                        ...
                                        <input type="text" readonly name="medical_expire_date"
                                            id="medical_expire_date" value="<?php
                                    ...
                                    <div class="py-1">
                                        ...
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full form-control uppercase" id="driving_licence"
                                            name="driving_licence" value="{{ $candidate->driving_licence }}">
                                    </div>
                                    <div class="py-1">
                                        <div class="font-bold text-lg">Police Clearence No</div>
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full form-control uppercase" id="police_licence"
                                            name="police_licence" value="{{ $candidate->police }}">
                                    </div>
                                </div>
                        ...
                        <div class="bg-white container shadow-2xl py-3 my-3 rounded-lg">
                            <div
                                class="flex text-[#082F2C] bg-[#ADCCC8] p-3 rounded-lg text-xl  font-semibold justify-between items-center">
                                <h2 class="">Candidate Visa Information</h2>
                            </div>
                            <div class="bg-white pb-4" id="visaedit">

                                <input type="hidden" name="uid" id="candidate_id"
                                    value="{{ $id }}" />
                                <div class="px-10 gap-x-10 grid md:grid-cols-2">
                                    <div class="py-1">
                                        <div class="font-bold text-lg">Visa No</div>
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full uppercase form-control" id="visa_no"
                                            name="visa_no" value="{{ $candidate->visa_no }}">
                                    </div>
                                    <div class="py-1">
                                        <div class="font-bold text-lg">Sponsor ID</div>
                                        <input type="text" readonly name="spon_id" id="spon_id"
                                    ...
                                    <div class="py-1">
                                        ...
                                        <input type="text" readonly name="visa_date" id="visa_date"
                                    ...
                                    <div class="py-1">
                                        ...
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full uppercase form-control" id="salary"
                                            name="salary" value="{{ $candidate->salary ?? '' }}">
                                    </div>
                                    <div class="py-1">
                                        <div class="font-bold text-lg">Sponsor Name (Arabic)</div>
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full uppercase form-control" id="spon_name_arabic"
                                            name="spon_name_arabic" value="{{ $candidate->spon_name_arabic ?? '' }}">
                                    </div>

                                    <div class="py-1">
                                        <div class="font-bold text-lg">Profession (Arabic)</div>
                                        <input type="text" readonly name="prof_name_arabic" id="prof_name_arabic"
                                            value="{{ $candidate->prof_name_arabic ?? '' }}"
                                            class="p-2 rounded-lg w-full uppercase form-control">
                                    </div>
                                    <div class="py-1">
                                        <div class="font-bold text-lg">Profession (English)</div>
                                        <input type="text" readonly name="prof_name_english"
                                            id="prof_name_english" value="{{ $candidate->prof_name_english ?? '' }}"
                                            class="p-2 rounded-lg w-full uppercase form-control">
                                    </div>
                                    <div class="py-1">
                                    ...
                                    <div class="py-1">
                                        ...
                                        <input type="text" readonly name="mofa_date"
                                            value="{{ $candidate->mofa_date ?? '' }}" id="mofa_date"
                                            class="p-2 rounded-lg w-full uppercase form-control">
                                    </div>
                                    <div class="py-1">
                                        <div class="font-bold text-lg">Okala No</div>
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full uppercase form-control" id="okala_no"
                                            name="okala_no" value="{{ $candidate->okala_no ?? '' }}">
                                    </div>
                                    <div class="py-1">
                                        <div class="font-bold text-lg">Musaned No</div>
                                        <input type="text" readonly
                                            class="p-2 rounded-lg w-full uppercase form-control" id="musaned_no"
                                            name="musaned_no" value="{{ $candidate->musaned_no ?? '' }}">
                                    </div>
