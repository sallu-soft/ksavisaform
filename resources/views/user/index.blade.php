      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header bg-[#289788] text-white">
            ...
            <button type="button" class="btn-close text-white bg-red-800 p-2 rounded-md flex items-center justify-center font-bold" data-bs-dismiss="modal" aria-label="Close">X</button>
          </div>
