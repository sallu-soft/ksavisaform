    ...
    <main class="flex">
        ...
        <div id="rightbar" class="flex-1 ml-[200px] md:ml-[240px] xl:ml-[280px]">
            ...
            <div class="">
                ...
                <form class="row g-3 m-0" id="addcandidate" method="post">
                    ...
                    <div class="mx-auto w-[60%]">
                        ...
                        <div class="bg-white container shadow-2xl py-3 my-3 rounded-lg">
                            <div
                                class="flex text-white bg-[#275E8B] rounded-t-lg p-3 text-xl  font-semibold justify-between items-center">
                                <h2 class="">Edit Candidate Information</h2>
                            </div>
                            <form class="bg-[#DBF4F1] pb-4" id="addcandidate" method="post">
                                <div class="px-10 gap-x-10 grid md:grid-cols-2">
                                    <div class="py-1">
                                        ...
                                        <select class="form-control select2" id="agent_id" name="agent_id" required>
                                            <option value="" disabled
                                                {{ is_null($candidate->agent) ? 'selected' : '' }}>Select Agent</option>
                                            @foreach ($agentsform as $agent)
                                                <option value="{{ $agent->id }}"
                                                    {{ $agent->id == $candidate->agent ? 'selected' : '' }}>
                                    ...
                                    <div class="py-1">
                                        ...
                                        <input type="text" class="p-2 rounded-lg w-full uppercase form-control"
                                            name="pname" id="pname" value="{{ $candidate->name }}" />
                                    </div>
                                    <div class="py-1">
                                        <div class="font-bold text-lg">Passport Number</div>
                                        <input type="text" class="p-2 rounded-lg w-full uppercase form-control"
                                            minlength="0" maxlength="9" id="pnumber" name="pnumber"
                                            value="{{ $candidate->passport_number }}" required />
                                    </div>
                                    <div class="py-1">
                                      <div class="font-bold text-lg">Passport Issue Date</div>
                                      <input type="date" class="p-2 rounded-lg w-full uppercase form-control"
                                          name="pass_issue_date" id="pass_issue_date"
                                          value="<?php
                                          $inputDate = $candidate->passport_issue_date ?? null;
                                  
                                          // Check if the date is not empty before formatting
                                          if (!empty($inputDate)) {
                                              echo date('Y-m-d', strtotime($inputDate)); // Convert to YYYY-MM-DD for date input
                                          }
                                          ?>">
                                  </div>
                                    ...
                                    <div class="py-1">
                                        ...
                                        <input type="date" class="p-2 rounded-lg w-full uppercase form-control"
                                            name="pass_expire_date" id="pass_expire_date"
                                            value="<?php
                                            $inputDate = $candidate->passport_expire_date ?? null;
                                    ...
                                    <div class="py-1">
                                        ...
                                        <input type="date" class="p-2 rounded-lg w-full uppercase form-control"
                                            ...
                                            value="<?php
                                            $inputDate = $candidate->date_of_birth ?? null;
                                    ...
                                    <div class="py-1">
                                        ...
                                        <input type="text" class="p-2 rounded-lg w-full uppercase form-control"
                                            name="place_of_birth" list="districts" id="place_of_birth"
                                            value="{{ $candidate->place_of_birth }}" />
                                    ...
                                    <div class="py-1">
                                        ...
                                        <input type="text" class="p-2 rounded-lg w-full uppercase form-control"
                                            name="father" id="father" value="{{ $candidate->father }}" />
                                    </div>
                                    <div class="py-1">
                                        <div class="font-bold text-lg">Mother's Name</div>
                                        <input type="text" class="p-2 rounded-lg w-full uppercase form-control"
                                            name="mother" id="mother" value="{{ $candidate->mother }}" />
                                    </div>
                                    <div class="py-1">
                                        <div class="font-bold text-lg">Religion</div>
                                        <select class="form-control p-2 rounded-lg w-full" name="religion"
                                            id="religion" size="large">
                                    ...
                                    <div class="py-1">
                                        ...
                                        <select class="form-control p-2 rounded-lg w-full" size="large"
                                            placeholder="Select a person" name="gender">
                                    ...
                                    <div class="py-1">
                                        ...
                                        <select class="form-control w-full p-2 rounded-lg" size="large"
                                    ...
                                    <div class="py-1">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control uppercase"
                                                value="<?php echo $candidate->address; ?>" id="address" placeholder=""
                                                name="address">
                                        </div>
                                    </div>
                                    <div class="py-1">
                                        ...
                                        <input type="text" class="p-2 rounded-lg w-full uppercase form-control"
                                            ...
                                            value="{{ $candidate->medical_center }}">
                                    </div>
                                    <div class="py-1">
                                      ...
                                      <input type="date" class="p-2 rounded-lg w-full uppercase form-control"
                                          ...
                                          if (!empty($inputDate)) {
                                              // Convert the date format to YYYY-MM-DD for the date input
                                              echo date('Y-m-d', strtotime($inputDate));
                                          }
                                          ?>">
                                  </div>
                                  <div class="py-1">
                                    <div class="font-bold text-lg">Medical Expire Date</div>
                                    <input type="date" name="medical_expire_date" id="medical_expire_date"
                                        value="<?php
                                        if (isset($candidate->medical_expire_date) && !empty($candidate->medical_expire_date)) {
                                            echo date('Y-m-d', strtotime($candidate->medical_expire_date)); // Ensure valid date format
                                        }
                                        ?>"
                                    ...
                                    <div class="py-1">
                                        ...
                                        <input type="text" class="p-2 rounded-lg w-full form-control uppercase"
                                            id="driving_licence" name="driving_licence"
                                            value="{{ $candidate->driving_licence }}">
                                    </div>
                                    <div class="py-1">
                                        <div class="font-bold text-lg">Police Clearence No</div>
                                        <div class="input-group">
                                            <input type="text" class="p-2 rounded-lg w-full form-control uppercase"
                                                id="police_licence" name="police_licence"
                                                value="{{ $candidate->police }}">
                                            <button type="button"
                ...
                <div class="bg-white container shadow-2xl py-3 my-3 rounded-lg">
                    <div
                        class="flex text-white bg-[#275E8B] p-3 rounded-t-lg text-xl  font-semibold justify-between items-center">
                        <h2 class="">Edit Candidate Visa Information</h2>
                    </div>
                    <form class="bg-white pb-4" action="" id="visaedit" method="post">
                        ...
                        <div class="px-10 gap-x-10 grid md:grid-cols-2">
                            <div class="py-1">
                                ...
                                <input type="text" class="p-2 rounded-lg w-full uppercase form-control"
                                    id="visa_no" name="visa_no" value="{{ $candidate->visa_no }}">
                            </div>
                            <div class="py-1">
                                <div class="font-bold text-lg">Sponsor ID</div>
                                <input type="text" name="spon_id" id="spon_id"
                                    value="{{ $candidate->spon_id }}"
                                    class="p-2 rounded-lg w-full uppercase form-control" required>
                            </div>
                            <div class="py-1">
                                <div class="font-bold text-lg">Visa Date (Hijri)</div>
                                <input type="text" name="visa_date" id="visa_date"
                                    value="{{ $candidate->visa_date2 ?? '' }}"
                                    class="p-2 rounded-lg w-full uppercase form-control">
                            </div>

                            <div class="py-1">
                                <div class="font-bold text-lg">Sponsor Name (Arabic)</div>
                                <input type="text" class="p-2 rounded-lg w-full uppercase form-control"
                                    id="spon_name_arabic" name="spon_name_arabic"
                                    value="{{ $candidate->spon_name_arabic ?? ' ' }}">
                            </div>
                            <div class="py-1">
                                <div class="font-bold text-lg">Sponsor Name (English)</div>
                                <input type="text" class="p-2 rounded-lg w-full uppercase form-control"
                                    id="spon_name_english" name="spon_name_english"
                                    value="{{ $candidate->spon_name_english ?? '' }}"
                                    placeholder="Sponsor Name in (English)" />
                            </div>
                            <div class="py-1">
                                <div class="font-bold text-lg">Profession (Arabic)</div>
                                <input type="text" name="prof_name_arabic" id="prof_name_arabic"
                                    value="{{ $candidate->prof_name_arabic ?? '' }}"
                                    class="p-2 rounded-lg w-full uppercase form-control">
                            </div>
                            <div class="py-1">
                                <div class="font-bold text-lg">Profession (English)</div>
                                <input type="text" name="prof_name_english" id="prof_name_english"
                                    value="{{ $candidate->prof_name_english ?? ' ' }}"
                                    class="p-2 rounded-lg w-full uppercase form-control">
                            </div>
                            <div class="py-1">
                                <div class="font-bold text-lg">Mofa No</div>
                                <input type="text" class="p-2 rounded-lg w-full uppercase form-control"
                                    id="mofa_no" name="mofa_no" value="{{ $candidate->mofa_no ?? '' }}">
                            </div>
                            <div class="py-1">
                                <div class="font-bold text-lg">Salary</div>
                                <input type="text" class="p-2 rounded-lg w-full uppercase form-control"
                                    id="salary" name="salary" value="{{ $candidate->salary ?? ' ' }}">
                            </div>
                            <div class="py-1">
                                <div class="font-bold text-lg">Okala No</div>
                                <input type="text" class="p-2 rounded-lg w-full uppercase form-control"
                                    id="okala_no" name="okala_no" value="{{ $candidate->okala_no ?? ' ' }}">
                            </div>
                            <div class="py-1">
                                <div class="font-bold text-lg">Musaned No</div>
                                <input type="text" class="p-2 rounded-lg w-full uppercase form-control"
                                    id="musaned_no" name="musaned_no" value="{{ $candidate->musaned_no ?? ' ' }}">
                            </div>
        ...
        @if ($manpower)
            <div class="w-[60%] mx-auto mt-5">
                <div class="bg-white container shadow-2xl py-3 my-3 rounded-lg">
                    <div
                        class="flex text-white bg-[#275E8B] rounded-t-lg p-3 text-xl  font-semibold justify-between items-center">
                        <h2 class="">Edit Candidate Manpower Information</h2>
                    </div>
                    <form id="manpowerinput" class="pt-4">
                        ...
                        <div class="row">
                            ...
                            @if ($manpower)
                                <input type="hidden" name="manpower_id" id="manpower_id"
                                    value="{{ $manpower->id }}" />
                            @endif

                            <div class="px-10 gap-x-10 grid md:grid-cols-2">
                                <div class="py-2 flex flex-col gap-2">
                                    <div class="font-bold text-lg">Passenger Number <span
                                            class="text-red-500">*</span></div>
                                    <input type="text" id="passenger_no" name="passenger_no"
                                        class="form-control p-2 rounded-lg w-full uppercase" required placeholder=""
                                        value="{{ old('passenger_no', $manpower->passenger_no ?? '') }}" />
                                </div>

                                <div class="py-2 flex flex-col gap-2">
                                    <div class="font-bold text-lg">Company Name <span class="text-red-500">*</span>
                                    </div>
                                    <input type="text" id="company_name" name="company_name"
                                        class="form-control p-2 rounded-lg w-full uppercase" required placeholder=""
                                        value="{{ old('company_name', $manpower->company_name ?? '') }}" />
                                </div>

                                <div class="py-2 flex flex-col gap-2">
                                    <div class="font-bold text-lg">Certificate No <span class="text-red-500">*</span>
                                    </div>
                                    <input type="text" id="certificate_no" name="certificate_no"
                                        class="form-control p-2 rounded-lg w-full uppercase" required placeholder=""
                                        value="{{ old('certificate_no', $manpower->certificate_no ?? '') }}" />
                                </div>

                                <div class="py-2 flex flex-col gap-2">
                                    <div class="font-bold text-lg">FFC Name <span class="text-red-500">*</span></div>
                                    <input type="text" id="ffc_name" name="ffc_name"
                                        class="form-control p-2 rounded-lg w-full uppercase" required placeholder=""
                                        value="{{ old('ffc_name', $manpower->ffc_name ?? '') }}" />
                                </div>

                                <div class="py-2 flex flex-col gap-2">
                                    <div class="font-bold text-lg">Registration ID <span class="text-red-500">*</span>
                                    </div>
                                    <input type="text" id="reg_id" name="reg_id"
                                        class="form-control p-2 rounded-lg w-full uppercase" required placeholder=""
                                        value="{{ old('reg_id', $manpower->reg_id ?? '') }}" />
                                </div>
                                ...
                                <div class="py-2 flex flex-col gap-2">
                                    ...
                                    <input type="text" id="visa_no" name="visa_no"
                                        class="form-control p-2 rounded-lg w-full uppercase" required placeholder=""
                                        value="{{ old('visa_no', $manpower->visa_no ?? '') }}" />
                                </div>

                                <div class="py-2 flex flex-col gap-2">
                                    <div class="font-bold text-lg">Visa Issued Date <span
                                            class="text-red-500">*</span></div>
                                    <input type="text" id="visa_issued_date" name="visa_issued_date"
                                        class="form-control p-2 rounded-lg w-full uppercase" required
                                        placeholder="DD-MM-YYYY"
                                        value="{{ old('visa_issued_date', $manpower->visa_issued_date ?? '') }}" />
                                </div>

                                <div class="py-2 flex flex-col gap-2">
                                    <div class="font-bold text-lg">Visa Expiration Date <span
                                            class="text-red-500">*</span></div>
                                    <input type="text" id="visa_exp_date" name="visa_exp_date"
                                        class="form-control p-2 rounded-lg w-full uppercase" required
                                        placeholder="DD-MM-YYYY"
                                        value="{{ old('visa_exp_date', $manpower->visa_exp_date ?? '') }}" />
                                </div>
                                <div class="py-2 flex flex-col gap-2">
                                    <div class="font-bold text-lg">Bank Name</div>
                                    <input type="text" id="bank_name" name="bank_name"
                                        class="form-control p-2 rounded-lg w-full uppercase" placeholder=""
                                        value="{{ old('bank_name', $manpower->bank_name ?? '') }}" />
                                </div>
                                <div class="py-2 flex flex-col gap-2">
                                    <div class="font-bold text-lg">Bank Account No</div>
                                    <input type="text" id="bank_acc_no" name="bank_acc_no"
                                        class="form-control p-2 rounded-lg w-full uppercase" placeholder=""
                                        value="{{ old('bank_acc_no', $manpower->bank_acc_no ?? '') }}" />
                                </div>
                            </div>
    ...
    $(document).ready(function() {
        $('#pnumber').on('change', function() {
            ...
            if (foundObject) {
                ...
                var licenceName = foundObject.user.licence_name ? foundObject.user.licence_name :
                    "Not available";
                alert(inputValue + " exists in database under: " + licenceName + '(' + foundObject.user
                    .rl_no + ')' + ' Contact here: ' + email);
                ...
                $.ajax({
                    ...
                    error: function(response) {
                        ...
                        if (response.responseJSON && response.responseJSON.redirect_url) {
                            setTimeout(function() {
                                var redirectUrl = window.location.origin + '/' +
                                    response.responseJSON.redirect_url;
                                window.location.href = redirectUrl;
                            }, 2000);
                        }
                    }
